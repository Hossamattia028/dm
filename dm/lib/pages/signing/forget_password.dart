  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          elevation: 0,
          title:Text(translate("signup.password"),
                      ...
                      children: [
                        Container(
                          ...
                          child: new TextFormField(
                            validator: (value) =>
                            value.isEmpty ? 'email password can\'t be empty' : null,
                        ...
                        SizedBox(
                            ...
                            child: RaisedButton(
                              ...
                              onPressed: ()async {
                                await resetProvider.forgetPassword(context: context,
                                    id: _emailEditingController.text.toString().trim());
                              },
